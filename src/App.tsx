    ...
    images: [
      {
        ...
        thumbnailPath: '/src/assets/images/image-product-1-thumbnail.jpg',
      },
      {
        id: 2,
        altText: 'Product 2',
        path: '/src/assets/images/image-product-2.jpg',
        thumbnailPath: '/src/assets/images/image-product-2-thumbnail.jpg',
      },
      {
        id: 3,
        altText: 'Product 3',
        path: '/src/assets/images/image-product-3.jpg',
        thumbnailPath: '/src/assets/images/image-product-3-thumbnail.jpg',
      },
      {
        id: 4,
        altText: 'Product 4',
        path: '/src/assets/images/image-product-4.jpg',
        thumbnailPath: '/src/assets/images/image-product-4-thumbnail.jpg',
      },
    ],
  },
];
